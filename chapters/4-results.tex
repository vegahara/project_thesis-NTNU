...
\begin{figure}
    \centering
    \includegraphics[trim=0cm 3cm 0cm 2.8cm, clip=true, width=1.0\textwidth]{figures/2D_tuning_parameters_training.eps}
    \caption[Results from testing the 2D landmark detector]{Results from running the 2D landmark detector on the test data}
     ...
     % Height 50-150, Area 100 FR 0.3 int thres 0.9
\end{figure}
...
\begin{figure}
    ...
    \caption[]{}
     \label{}
     % Height 50-150, Area 100 FR 0.3 int thres 0.85 no gaussian morph size 10
\end{figure}
...
\begin{figure} % order of priority: h here, t top, b bottom, p page
    ...
    \begin{subfigure}[t]{1.0\textwidth}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         \centering
         \includegraphics[trim=11cm 0cm 12cm 0cm, clip=true, width=\textwidth]{figures/1D_norm_result_test.eps}
     ...
     \begin{subfigure}[b]{0.48\textwidth}
         \centering
         \includegraphics[trim=11cm 0cm 12cm 0cm, clip=true, width=\textwidth]{figures/2D_result_single_test.eps}
